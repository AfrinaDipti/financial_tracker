...
class FinancialTracker:
    ...
    def __init__(self, root):
        ...
        self.root.geometry("400x800")  # Narrower width, taller height for mobile format
    ...
    def show_spending_chart(self):
        ...
        try:
            ...
            plt.ylabel("Amount ($)", labelpad=10, fontsize=12)
    ...
    def show_monthly_trends_chart(self):
        ...
        try:
            ...
            ax1.set_ylabel("Total Amount ($)", labelpad=10)
